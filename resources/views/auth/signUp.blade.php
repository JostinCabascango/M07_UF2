...
<body>
    ...
    <form method="post" action="{{ url('login') }}" class="max-w-md mx-auto my-10">
        @csrf
        <div class="mb-4">
    ...
    <p class="text-center">¿tienes una cuenta? <a href="{{ url('login') }}" class="text-blue-500">Inicia sesion</a></p>
</body>
