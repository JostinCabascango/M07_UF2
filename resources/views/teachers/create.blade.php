...
<body class="bg-gray-100">
    <h1 class="text-3xl font-bold text-center text-gray-800 mt-4">Crear Estudiante</h1>
    <form method="post" action="{{ route('teacher.store') }}" class="max-w-md mx-auto my-10">
        @csrf
        <div class="mb-4">
